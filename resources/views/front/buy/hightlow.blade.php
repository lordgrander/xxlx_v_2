                        ...
                        <tbody>
                            <tr> 
                                <td class="text-center" width="50%">
                                    <select name="" id="inputValues" class="form-control">
                                        @if($gain_number=='69')
                                            <option value="ແທງສູງ">ແທງສູງ</option>
                                            <option value="ແທງຕ່ຳ">ແທງຕ່ຳ</option>
                                        @else
                                            <option value="ແທງຄີກ">ແທງຄີກ</option>
                                            <option value="ແທງຄູ່">ແທງຄູ່</option>
                                        @endif
                                    </select>
                                </td>
                                <td class="text-right"> 
      ...
      $(document).ready(function() {
        $('#inputValues').focus();
            ...
            $('#goButton').click(function() {
                ...
                if (numbers) { 
                        var inputField = `<input type="text" disabled class="form-control number-input text-center simple-input number" value="${numbers}">`;
